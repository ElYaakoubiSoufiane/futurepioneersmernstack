...
import img from "../../assets/ISLAMIC3.jpg";
import "../../App.css";
...
export default function ReligionActivities() {
  useEffect(() => {
    window.scrollTo(0, 0);
  }, []);
  ...
  >
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
      ...
      <div className="sf:text-center md:text-left  lg:py-24">
        <h2 className="text-3xl font-bold sm:text-4xl">Religion Activities</h2>
        ...
        <Link
        to ="/activities/religion/pictures"
