...
import img from "../../assets/SocialIcon.jpg";
import "../../App.css";
  ...
  >
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-2 lg:gap-16">
      ...
      <div className="sf:text-center md:text-left  lg:py-24">
        <h2 className="text-3xl font-bold sm:text-4xl">Social Activities</h2>

        <p className="mt-4 mb-10 text-gray-600">
        Social establishments receive special attention from the club, which organizes a blood donation campaign within the institution, as well as other voluntary activities, one of which is one of the most notable is HAMLAT LAMSAT DIFAE 
        </p>

        <Link
        to ="/activities/social/pictures"
